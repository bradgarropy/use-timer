...
```bash
git clone https://github.com/<username>/use-timer
```
...
[license]: https://github.com/bradgarropy/use-timer/blob/master/license
[fork]: https://github.com/bradgarropy/use-timer/fork
[contributors]: https://github.com/bradgarropy/use-timer#-contributors
